...
import { Search, SlidersHorizontal, Grid, List, Star, MapPin, Clock, ChevronDown, Briefcase, DollarSign, Calendar, Users, PlusCircle } from "lucide-react";
...
const ExplorePage = () => {
  ...
  // Filter job posts based on search
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    // Just filter in place, no navigation needed
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="inline-flex rounded-full bg-gray-100 p-1">
                <button
                  ...
                  className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition-all ${exploreMode === "talent"
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition-all ${exploreMode === "work"
                      ? "bg-white text-gray-900 shadow-md"
                      : "text-gray-600 hover:text-gray-900"
                    }`}
                >
              ...
              <Link
                href="/post-gig"
                className="ml-4 flex justify-center items-center rounded-full bg-emerald-500 px-6 py-2 text-sm font-semibold text-white shadow-md transition-colors hover:bg-emerald-700"
              >
                <PlusCircle className="mr-2 h-5 w-5" />Post Gig
              </Link>
            </div>
          </div>
        </div>
          ...
          <>
            {filteredFreelancers.length === 0 ? (
              <div className="py-20 text-center">
                ...
                <p className="mt-4 text-xl text-gray-500">No professionals found</p>
          ...
          <>
            {filteredJobs.length === 0 ? (
              <div className="py-20 text-center">
                ...
                <p className="mt-4 text-xl text-gray-500">No jobs found</p>
                <p className="mt-2 text-gray-400">Try adjusting your search</p>
              </div>
            ) : (
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                          ...
                          <span className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${job.experienceLevel === "Expert"
